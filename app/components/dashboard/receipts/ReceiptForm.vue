  ...
  <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div>
        ...
        <div class="relative">
          ...
          <input
            ...
            placeholder="0.00"
            :class="[
              'w-full pl-8 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500',
    ...
    <div>
      ...
      <textarea
        ...
        :class="[
          'w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-none',
    ...
    <div class="flex gap-3 pt-4">
      ...
      <button
        type="submit"
        class="flex-1 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 disabled:bg-green-400 disabled:cursor-not-allowed"

...
const handleSubmit = async () => {
  ...
  try {
    ...
    } else if (err.data?.error?.code === 'VALIDATION_ERROR') {
      errorMessage = err.data.error.details?.join(', ') || 'Please check your input and try again.'
